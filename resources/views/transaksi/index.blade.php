                ...
                <div class="card-body">
                    <form action="{{ route('transaksi.simpan') }}" method="post">
                                        ...
                                        <table class="table table-stripped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $item->id }}</td>
                                                    <td>
                                                        <input type="text" class="form-control" name="tagihan[]" value="{{ $item->id }}" hidden>
                                                        <input type="text" class="form-control" value="{{ $item->nama }}" readonly>
                                                    </td>
                                                    <td><input type="number" class="form-control" name="jml[]" value="0"></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                        ...
                        <div class="d-flex">
                            ...
                            {{-- <button class="btn btn-primary ml-auto" id="btn-simpan">Simpan</button> --}}
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table card-table table-hover table-vcenter text-wrap">
                        ...
                        @foreach ($transaksi as $index => $item)
                            <tr>
                                {{-- <td><span class="text-muted">{{ $item->transaksi_id }}</span></td> --}}
                                <td><span class="text-muted">@php echo $i; @endphp</span></td>
                                <td>{{ $item->updated_at->format('d-m-Y, H:m a') }}</td>
                                <td>
                                    <a href="{{ route('siswa.show', $item->id_siswa) }}" target="_blank">
                                ...
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input tandai" name="example-checkbox2" value="{{ $item->transaksi_id }}">
    ...
    require(['jquery','select2','sweetalert'], function ($, select2, sweetalert) {
        $(document).ready(function () {
            ...
            $('#mass-cetak').on('click', function(){
                ...
                if (ids.length === 0) {
                    alert('Pilih minimal satu Histori Transaksi.');
                } else {
                    form.submit();
                }
