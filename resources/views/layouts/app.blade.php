			...
			<div class="container">
				<div class="row align-items-center flex-row-reverse">
					<div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
						Copyright © 2022 <a href=".">Tabler</a>. Theme by <a href="https://codecalm.net"
							target="_blank">codecalm.net</a> Used and Modified By <a href="https://www.linkedin.com/in/muhammad-arizal-83b782216" target="_blank">ARzzz</a> All rights reserved.
					</div>
				</div>
			</div>
		</footer>
